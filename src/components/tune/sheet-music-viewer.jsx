...
export function SheetMusicViewer({ attachment }) {
  ...
  if (isPdf) {
    return (
      <div>
        ...
        <a href={url} target="_blank" rel="noopener" class="text-xs text-brand-600 hover:underline mt-1 inline-block">
          Open PDF in new tab
        </a>
      </div>
    );
  ...
  return (
    <a href={url} target="_blank" rel="noopener" class="text-sm text-brand-600 hover:underline">
